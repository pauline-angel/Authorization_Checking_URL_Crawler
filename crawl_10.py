...
def access_uncommon_paths(driver, uncommon_paths, user_credentials, main_domain):
    """Attempts to access the uncommon paths using the credentials provided."""
    print(f"\nAttempting to access uncommon paths using {user_credentials['username']}'s credentials:")
...
if __name__ == "__main__":
    ...
    access_uncommon_paths(driver, user_uncommon_paths, user2_credentials, user_main_domain)

    # Access User2's uncommon paths with User1's credentials
    access_uncommon_paths(driver, admin_uncommon_paths, user1_credentials, admin_main_domain)
